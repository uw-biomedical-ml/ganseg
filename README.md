...
GANSeg's schema is given in Figure 1b, and can be contrasted against traditional supervised learning setups in Figure 1a. ![Figure 1](https://github.com/uw-biomedical-ml/blob/ganseg/master/Figure1.png)
